...
function SidebarHeader({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar='header'
      className={cn('flex flex-col items-center justify-center gap-2 p-2', className)}
      {...props}
    />
  )
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'h-8 group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0',
        className
      )}
      {...props}
    />
  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        '!bg-transparent text-sm text-[#898D9B]',
        className
      )}
      {...props}
    />
